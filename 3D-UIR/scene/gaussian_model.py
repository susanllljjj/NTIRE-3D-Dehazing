...
from scene.appearace_model import EmbeddingModel, BackscatterNet, DeattenuateNet
...
class GaussianModel:
    ...
    def __init__(self, sh_degree, optimizer_type="default"):
        ...
        self.bs_model = BackscatterNet().to("cuda")
        self.da_model = DeattenuateNet().to("cuda")
    ...
    def training_setup(self, training_args):
        ...
        l.extend([
            {'params': self.bs_model.parameters(), 'lr': training_args.bs_lr, "name": "Bs_Model"},
            {'params': self.da_model.parameters(), 'lr': training_args.da_lr, "name": "Da_Model"}
        ])
        ...
        # Medium MLP learning rate scheduler
    ...
    def save_weights(self, model_path):
        out_weights_path = model_path
        save_dict = {
            "appearance_mlp": self.appearance_mlp.state_dict(),
            "embeddings": self.embeddings,  
            "bs_model": self.bs_model.state_dict(),
            "da_model": self.da_model.state_dict(),
        }

        torch.save(save_dict, out_weights_path)
    ...
    def load_weights(self, model_path):
        ...
        self.bs_model.load_state_dict(checkpoint["bs_model"])
        self.da_model.load_state_dict(checkpoint["da_model"])
