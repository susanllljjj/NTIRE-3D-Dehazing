...
class FSNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # 改为：
        #depth_2 = torch.nn.functional.avg_pool2d(depth, kernel_size=2, stride=2)
        #depth_4 = F.interpolate(depth_2, scale_factor=0.5)
        depth_2 = F.avg_pool2d(depth, kernel_size=2, stride=2)
        depth_4 = F.avg_pool2d(depth_2, kernel_size=2, stride=2)
